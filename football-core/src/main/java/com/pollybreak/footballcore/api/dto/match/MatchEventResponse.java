...
public record MatchEventResponse(
        ...
        String relatedPlayerUsername,
        String relatedPlayerPhotoUrl,
        String relatedPlayerTelegramPhotoUrl,
        Long linkedEventId,
    ...
    public static MatchEventResponse fromEntity(MatchEvent event) {
        return new MatchEventResponse(
                ...
                event.getPlayer() != null && event.getPlayer().getUser() != null ? event.getPlayer().getUser().getDisplayName() : null,
                event.getPlayer() != null && event.getPlayer().getUser() != null ? event.getPlayer().getUser().getUsername() : null,
                event.getPlayer() != null ? event.getPlayer().getEffectivePhotoUrl() : null,
                event.getPlayer() != null ? event.getPlayer().getTelegramPhotoUrl() : null,
                ...
                event.getRelatedPlayer() != null && event.getRelatedPlayer().getUser() != null ? event.getRelatedPlayer().getUser().getDisplayName() : null,
                event.getRelatedPlayer() != null && event.getRelatedPlayer().getUser() != null ? event.getRelatedPlayer().getUser().getUsername() : null,
                event.getRelatedPlayer() != null ? event.getRelatedPlayer().getEffectivePhotoUrl() : null,
                event.getRelatedPlayer() != null ? event.getRelatedPlayer().getTelegramPhotoUrl() : null,
