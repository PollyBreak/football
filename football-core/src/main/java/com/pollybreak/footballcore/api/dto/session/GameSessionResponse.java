...
public record GameSessionResponse(
        ...
        Long telegramContributionPollMessageId,
        String telegramContributionPollId,
    ...
    public static GameSessionResponse fromEntity(GameSession session, List<SessionTeam> teams) {
        return new GameSessionResponse(
                ...
                session.getTelegramContributionPollMessageId(),
                session.getTelegramContributionPollId(),
